...
export default function LaserAlignmentHeroContent() {
  ...
  return (
    <section className="relative flex min-h-[calc(100vh-5.5rem)] w-full flex-col overflow-hidden rounded-3xl px-4 sm:px-6 md:px-8 lg:px-10">
      <div className="mt-10 flex flex-1 flex-col justify-center gap-14">
        ...
        <div className="space-y-4">
          ...
          <p className="text-secondary-600 max-w-2xl text-center text-sm leading-relaxed sm:text-left sm:text-base md:text-lg">
            {"PPP's laser shaft alignment service ensures your rotating machinery runs efficiently, reducing energy waste, preventing premature failures, and extending asset life through pinpoint precision."
              .split(" ")
              .map((word, idx) => (
                <motion.span
      ...
      >
        <Image
          src="/images/services/laser-alignment-hero.jpg"
          fill
          priority
          alt="Hero image"
