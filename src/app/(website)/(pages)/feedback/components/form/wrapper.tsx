...
import { getCourses } from "../../../training/_components/courses/wrapper";
import FeedbackFormContent from "./content";
...
export default async function FeedbackFormWrapper({ searchParams }: Props) {
  ...
  return <FeedbackFormContent courses={courses} />;
}
