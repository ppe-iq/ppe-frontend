...
export default function CategoriesHeroContent() {
    ...
    <section className="relative flex min-h-[calc(100vh-5.5rem)] w-full flex-col overflow-hidden rounded-3xl px-4 sm:px-6 md:px-8 lg:px-10">
      <div className="mt-10 flex flex-1 flex-col justify-center gap-14">
        ...
        <div className="space-y-4">
          ...
          >
            From innovative sensors to advanced alignment systems, our products
            are thoughtfully engineered to deliver precision, durability, and
            user-focused performance in every environment.
          </motion.p>
        </div>
      </div>
